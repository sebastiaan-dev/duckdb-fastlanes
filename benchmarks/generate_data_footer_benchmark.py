...
def gen_dec_fsst_opr_str(n_rows, n_cols):
    ...
    """
    base = "_1234567890_1234567890_prefix_"
    data = []
    for i in range(n_rows):
        row = []
...
def generate_all_encodings():
    ...
    for n_cols in [1]:
        for n_rows in [1024 * 1, 1024 * 32, 1024 * 64]:
            result.update(
                {
                    f"dec_uncompressed_opr_uint8_{n_cols}_{n_rows}": gen_dec_uncompressed_opr_uint8(
                        n_rows, n_cols
                    ),
                    f"dec_uncompressed_opr_int8_{n_cols}_{n_rows}": gen_dec_uncompressed_opr_int8(
                        n_rows, n_cols
                    ),
                    f"dec_uncompressed_opr_int16_{n_cols}_{n_rows}": gen_dec_uncompressed_opr_int16(
                        n_rows, n_cols
                    ),
                    f"dec_uncompressed_opr_int32_{n_cols}_{n_rows}": gen_dec_uncompressed_opr_int32(
                        n_rows, n_cols
                    ),
                    f"dec_uncompressed_opr_int64_{n_cols}_{n_rows}": gen_dec_uncompressed_opr_int64(
                        n_rows, n_cols
                    ),
                    f"dec_uncompressed_opr_dbl_{n_cols}_{n_rows}": gen_dec_uncompressed_opr_dbl(
                        n_rows, n_cols
                    ),
                    f"dec_uncompressed_opr_str_{n_cols}_{n_rows}": gen_dec_uncompressed_opr_str(
                        n_rows, n_cols
                    ),
                    ########################################
                    f"dec_unffor_opr_uint8_{n_cols}_{n_rows}": gen_dec_unffor_opr_uint8(
                        n_rows, n_cols
                    ),
                    f"dec_unffor_opr_int8_{n_cols}_{n_rows}": gen_dec_unffor_opr_int8(
                        n_rows, n_cols
                    ),
                    f"dec_unffor_opr_int16_{n_cols}_{n_rows}": gen_dec_unffor_opr_int16(
                        n_rows, n_cols
                    ),
                    f"dec_unffor_opr_int32_{n_cols}_{n_rows}": gen_dec_unffor_opr_int32(
                        n_rows, n_cols
                    ),
                    f"dec_unffor_opr_int64_{n_cols}_{n_rows}": gen_dec_unffor_opr_int64(
                        n_rows, n_cols
                    ),
                    ########################################
                    f"dec_alp_opr_dbl_{n_cols}_{n_rows}": gen_dec_alp_opr_dbl(
                        n_rows, n_cols
                    ),
                    f"dec_alp_rd_opr_dbl_{n_cols}_{n_rows}": gen_dec_alp_rd_opr_dbl(
                        n_rows, n_cols
                    ),
                    ########################################
                    f"dec_constant_opr_uint8_{n_cols}_{n_rows}": gen_dec_constant_opr_uint8(
                        n_rows, n_cols
                    ),
                    f"dec_constant_opr_int8_{n_cols}_{n_rows}": gen_dec_constant_opr_int8(
                        n_rows, n_cols
                    ),
                    f"dec_constant_opr_int16_{n_cols}_{n_rows}": gen_dec_constant_opr_int16(
                        n_rows, n_cols
                    ),
                    f"dec_constant_opr_int32_{n_cols}_{n_rows}": gen_dec_constant_opr_int32(
                        n_rows, n_cols
                    ),
                    f"dec_constant_opr_int64_{n_cols}_{n_rows}": gen_dec_constant_opr_int64(
                        n_rows, n_cols
                    ),
                    f"dec_constant_opr_dbl_{n_cols}_{n_rows}": gen_dec_constant_opr_dbl(
                        n_rows, n_cols
                    ),
                    f"dec_constant_opr_str_{n_cols}_{n_rows}": gen_dec_constant_opr_str(
                        n_rows, n_cols
                    ),
                    ########################################
                    f"dec_fsst_opr_str_{n_cols}_{n_rows}": gen_dec_fsst_opr_str(
                        n_rows, n_cols
                    ),
                    f"dec_fsst12_opr_str_{n_cols}_{n_rows}": gen_dec_fsst12_opr_str(
                        n_rows, n_cols
                    ),
                    ########################################
                    f"dec_null_opr_int16_{n_cols}_{n_rows}": gen_dec_null_opr_int16(
                        n_rows, n_cols
                    ),
                    f"dec_null_opr_int32_{n_cols}_{n_rows}": gen_dec_null_opr_int32(
                        n_rows, n_cols
                    ),
                    f"dec_null_opr_dbl_{n_cols}_{n_rows}": gen_dec_null_opr_dbl(
                        n_rows, n_cols
                    ),
                    ########################################
                    # "dec_slpatch_opr_i16": gen_dec_slpatch_opr_i16(n_rows, n_cols),
                    ########################################
                    f"dec_frequency_opr_int8_{n_cols}_{n_rows}": gen_dec_frequency_opr_int8(
                        n_rows, n_cols
                    ),
                    f"dec_frequency_opr_int16_{n_cols}_{n_rows}": gen_dec_frequency_opr_int16(
                        n_rows, n_cols
                    ),
                    f"dec_frequency_opr_int32_{n_cols}_{n_rows}": gen_dec_frequency_opr_int32(
                        n_rows, n_cols
                    ),
                    f"dec_frequency_opr_int64_{n_cols}_{n_rows}": gen_dec_frequency_opr_int64(
                        n_rows, n_cols
                    ),
                    f"dec_frequency_opr_dbl_{n_cols}_{n_rows}": gen_dec_frequency_opr_dbl(
                        n_rows, n_cols
                    ),
                    f"dec_frequency_opr_str_{n_cols}_{n_rows}": gen_dec_frequency_opr_str(
                        n_rows, n_cols
                    ),
                    ########################################
                    f"dec_cross_rle_opr_int8_{n_cols}_{n_rows}": gen_dec_cross_rle_opr_int8(
                        n_rows, n_cols
                    ),
                    f"dec_cross_rle_opr_int16_{n_cols}_{n_rows}": gen_dec_cross_rle_opr_int16(
                        n_rows, n_cols
                    ),
                    f"dec_cross_rle_opr_int32_{n_cols}_{n_rows}": gen_dec_cross_rle_opr_int32(
                        n_rows, n_cols
                    ),
                    f"dec_cross_rle_opr_int64_{n_cols}_{n_rows}": gen_dec_cross_rle_opr_int64(
                        n_rows, n_cols
                    ),
                    f"dec_cross_rle_opr_dbl_{n_cols}_{n_rows}": gen_dec_cross_rle_opr_dbl(
                        n_rows, n_cols
                    ),
                    f"dec_cross_rle_opr_str_{n_cols}_{n_rows}": gen_dec_cross_rle_opr_str(
                        n_rows, n_cols
                    ),
                }
            )
...
def write_all_encodings_to_csv():
    ...
    for name, (data, col_type) in encodings.items():
        path = f"footer-benchmark/source/{name}"
